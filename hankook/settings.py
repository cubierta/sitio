...
# MEDIA_ROOT = os.path.join( PROJECT_ROOT, 'pictures')
...
# SECRET_KEY = '#v86u&amp;&amp;=mpl*jc-$tbto=b5ftx+xm=ebsit=ss%u9g$iwa=v&amp;('
...
# EMAIL_HOST_USER = 'albarenga72@gmail.com'
# EMAIL_HOST_PASSWORD = 'lra00218306'
# EMAIL_PORT = 587
# EMAIL_USE_TLS = True
...
#Esta linea se debe dejar en False cuando se pasa a produccion
#DEBUG = False, 
DEBUG = True
TEMPLATE_DEBUG = DEBUG
...
#'NAME': '/ruta_del_directorio_del_proyecto/hankook/hankook.db',
DATABASES = {
    'default': {
        'ENGINE': 'django.db.backends.sqlite3', # Add 'postgresql_psycopg2', 'mysql', 'sqlite3' or 'oracle'.
        'NAME': 'base',          # Or path to database file if using sqlite3.
...
# Absolute filesystem path to the directory that will hold user-uploaded files.
# Example: "/home/media/media.lawrence.com/media/"
MEDIA_ROOT = os.path.join(RUTA_PROYECTO,'pictures')
